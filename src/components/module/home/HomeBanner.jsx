        ...
        <div className="banner flex justify-between items-center">
          <div className="banner-content max-w-[600px] text-white">
            ...
            <p className="leading-7 mb-10">
              ...
              fuga at voluptatum sunt, ea, ipsum obcaecati eveniet deleniti
              dolorum ut illo fugit vero perferendis harum earum vel id libero
              dolor!
            </p>
            <Button height="55" kind="secondary" to="/sign-up">
              Get started
            </Button>
          </div>
